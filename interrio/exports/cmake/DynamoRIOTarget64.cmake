...
foreach(_expectedTarget dynamorio dynamorio_static drinjectlib drdecode drlibc drmemfuncs drconfiglib drfrontendlib drmemtrace_dependence_distance drmemtrace_reuse_distance drmemtrace_histogram drmemtrace_reuse_time drmemtrace_basic_counts drmemtrace_opcode_mix drmemtrace_view drmemtrace_func_view drmemtrace_simulator directory_iterator drmemtrace_raw2trace drmemtrace_analyzer drcontainers drmgr drmgr_static drx drx_static drwrap drwrap_static drreg drreg_static drsyms drsyms_static drutil drutil_static drcovlib drcovlib_static)
...
# Create imported target drmemtrace_dependence_distance
add_library(drmemtrace_dependence_distance STATIC IMPORTED)
...
set_target_properties(drmemtrace_raw2trace PROPERTIES
  INTERFACE_LINK_LIBRARIES "dynamorio;directory_iterator;drfrontendlib;drutil_static;/usr/lib/x86_64-linux-gnu/libpthread.so"
)
...
set_target_properties(drmemtrace_analyzer PROPERTIES
  INTERFACE_LINK_LIBRARIES "directory_iterator;/usr/lib/x86_64-linux-gnu/libpthread.so"
)
...
SET_PROPERTY(TARGET drmemtrace_dependence_distance PROPERTY MAP_IMPORTED_CONFIG_RELEASE RelWithDebInfo)
SET_PROPERTY(TARGET drmemtrace_dependence_distance PROPERTY MAP_IMPORTED_CONFIG_RELMINSIZE RelWithDebInfo)
