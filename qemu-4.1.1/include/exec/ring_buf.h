...
extern int ringbuf_init(size_t size, size_t n, int key);

extern int ringbuf_push_new(uint32_t index_w);

extern int ringbuf_get_index(size_t len , int pid);

extern void * shm_getaddr_from_idx(uint32_t index_w);
