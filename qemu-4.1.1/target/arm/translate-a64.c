...
#ifdef PPI_QR_FUNC
extern void  ppi_insert_end_branch(DisasContext *s);
#endif
static inline void gen_goto_tb(DisasContext *s, int n, uint64_t dest)
{
    //printf("gen_goto_tb!!\n");
    //TCGv_i64 temp_addr;
    //printf("dest tb pc ==0x40000000000%lx\n",dest);
...
static void disas_uncond_b_imm(DisasContext *s, uint32_t insn)
{
    ...
    if (insn & (1U << 31)) {
        ...
        ppi_insert_reg(REG_NEW, 2, 30, REG_WRITE);
#endif
#endif
    ...
    reset_btype(s);
    //gen_helper_bb_begin(cpu_env);
    //gen_helper_bb_addr(temp_addr);  //immediate jump addr
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
        ppi_insert_reg(REG_NEW, 2, rt, REG_READ);
#endif
#endif
...
#ifdef PPI_QR_REG_TRACE
    /* double check needed */
    uint32_t is_read = l ? REG_READ : REG_WRITE;
    ppi_insert_reg(REG_NEW, 2, rt, is_read);
#endif
#endif
...
#ifdef PPI_QR_FUNC
	    if ( imm16 ==0x9876 ) {
            	printf("user apps start, get imm16 = %x\n",imm16);
        	TCGv_ptr dcs = tcg_const_ptr(s->base.tb);
	        gen_helper_outreg_callback(dcs, cpu_env);
	        tcg_temp_free_ptr(dcs);
		break;
      	    } else if (imm16 ==0x9877) {
            	printf("user app pid/tgid align \n");
            	TCGv_ptr dcs = tcg_const_ptr(s->base.tb);
            	gen_helper_pid_callback(dcs, cpu_env);
            	tcg_temp_free_ptr(dcs);
            	break;
      	    } else if (imm16 ==0x9875) {
           	printf("user apps end, get imm16 = %x\n",imm16);
            	TCGv_ptr dcs = tcg_const_ptr(s->base.tb);
            	gen_helper_outreg_end_callback(dcs, cpu_env);
            	tcg_temp_free_ptr(dcs);
            	break;
	    } else if (imm16 ==0x9878) {
           	printf("user apps get dynamic-link offset, get imm16 = %x\n",imm16);
            	TCGv_ptr dcs = tcg_const_ptr(s->base.tb);
            	gen_helper_map_callback(dcs, cpu_env);
		tcg_temp_free_ptr(dcs);
            	break;
	    } 
#endif
...
static void disas_uncond_b_reg(DisasContext *s, uint32_t insn)
{
    ...
    case 2: /* RET */
        ...
        if (opc == 1) {
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 4, rn, REG_READ, 30, REG_WRITE);
#endif
#endif
            ...
            ppi_insert_reg(REG_NEW, 2, rn, REG_READ);
        }
#endif
#endif
...
{
    //ppi_insert_end_branch move to gen_goto_tb
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
        ppi_insert_reg(REG_NEW, 6, rn, REG_READ, rt, REG_READ, rs, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
        ppi_insert_reg(REG_NEW, 4, rn, REG_READ, rt, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
        ppi_insert_reg(REG_NEW, 4, rn, REG_READ, rt, REG_READ);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 8, rn, REG_READ, rt, REG_READ, rt2, REG_READ, rs, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 14, rs, REG_READ, rs + 1, REG_READ, rt, REG_READ,
                    rt + 1, REG_READ, rn, REG_READ, rs, REG_WRITE, rs + 1, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 6, rn, REG_READ, rt, REG_WRITE, rt2, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 8, rs, REG_READ, rt, REG_READ, rn, REG_READ, rs, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_NEW, 2, rt, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_OLD, 2, rt2, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_OLD, 2, rt2, REG_READ);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 6, rn, REG_READ, rt2, REG_WRITE, rt, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 6, rn, REG_READ, rt, REG_READ, rt2, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
        ppi_insert_reg(REG_OLD, 2, rn, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 6, rn, REG_READ, rm, REG_READ, rt, REG_READ);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 6, rn, REG_READ, rm, REG_READ, rt, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_NEW, 6, rs, REG_READ, rn, REG_READ, rt, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
                    ppi_insert_reg(REG_OLD, 2, tt, REG_READ);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
                    ppi_insert_reg(REG_OLD, 2, tt, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_OLD, 4, rm, REG_READ, rn, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_OLD, 2, rt, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
                ppi_insert_reg(REG_OLD, 2, rt, REG_READ);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_NEW, 2, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_NEW, 4, rn, REG_READ, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
        ppi_insert_reg(REG_NEW, 4, rd, REG_READ, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
        ppi_insert_reg(REG_NEW, 6, rd, REG_READ, rn, REG_READ, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 4, rm, REG_READ, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 6, rm, REG_READ, rn, REG_READ, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_NEW, 6, rn, REG_READ, rm, REG_READ, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_NEW, 8, rn, REG_READ, rm, REG_READ, ra, REG_READ, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_NEW, 4, rn, REG_READ, rn, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
        ppi_insert_reg(REG_NEW, 2, y, REG_READ);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_OLD, 2, rn, REG_READ);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_NEW, 4, rn, REG_READ, rm, REG_READ);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    /* ARM Architecture Reference Mannual DDI0487B_a_armv8_arm Page1649 */
    ppi_insert_reg(REG_NEW, 2, rm, REG_READ);
    int n = len;
    int _rn = rn;
    for (int i = 0; i < n; i++) {
        ppi_insert_reg(REG_OLD, 2, _rn, REG_READ);
        _rn = (_rn + 1) % 32;
    }
    if (is_tblx) {
        ppi_insert_reg(REG_OLD, 2, rd, REG_READ);
    }
    ppi_insert_reg(REG_OLD, 2, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    ppi_insert_reg(REG_NEW, 6, rn, REG_READ, rd, REG_READ, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
            ppi_insert_reg(REG_NEW, 8, rn, REG_READ, rm, REG_READ, rd, REG_READ, rd, REG_WRITE);
#endif
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
        /* ARM Architecture Reference Mannual DDI0487B_a_armv8_arm Page287&288 */
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    int _rm = extract32(insn, 16, 5);
    int _rn = extract32(insn, 5, 5);
    int _rd = extract32(insn, 0, 5);
    ppi_insert_reg(REG_NEW, 6, _rn, REG_READ, _rm, REG_READ, _rd, REG_WRITE);
#endif
#endif
...
static void disas_simd_indexed(DisasContext *s, uint32_t insn)
{
    ...
    switch (16 * u + opcode)
    {
    case 0x10: /* MLA */ case 0x14: /* MLS */ case 0x02: /* SMLAL, SMLAL2 */
    case 0x12: /* UMLAL, UMLAL2 */ case 0x06: /* SMLSL, SMLSL2 */ case 0x16: /* UMLSL, UMLSL2 */
    case 0x03: /* SQDMLAL, SQDMLAL2 */ case 0x07: /* SQDMLSL, SQDMLSL2 */ case 0x0d: /* SQRDMULH */
    case 0x01: /* FMLA */ case 0x05: /* FMLS */ case 0x1d: /* SQRDMLAH */ case 0x1f: /* SQRDMLSH */
        ppi_insert_reg(REG_NEW, 8, rn, REG_READ, rm, REG_READ, rd, REG_READ, rd, REG_WRITE);
        break;
    
    case 0x08: /* MUL */ case 0x0a: /* SMULL, SMULL2 */ case 0x1a: /* UMULL, UMULL2 */
    case 0x0b: /* SQDMULL, SQDMULL2 */ case 0x0c: /* SQDMULH */ case 0x09: /* FMUL */ case 0x19: /* FMULX */
        ppi_insert_reg(REG_NEW, 6, rn, REG_READ, rm, REG_READ, rd, REG_WRITE);
        break;
    }
#endif
...
#ifdef PPI_QR_FUNC
#ifdef PPI_QR_REG_TRACE
    /* Instruction not found in DDI0487B_a_armv8_arm */
#endif
#endif
...
static void disas_a64_insn(CPUARMState *env, DisasContext *s)
{
    ...
    if ( global_qrtag_flag == 0 || global_qrtag_flag == 2 ){
    	struct tb_trace *ptt = s->base.tb->tt;
    	ptt->ti[ptt->insn_num].pc = s->pc;
    	ptt->ti[ptt->insn_num].instr = s->insn;
        if(env->process_tb != NULL){
          int mmu_idx = cpu_mmu_index(env,false);
          void *hva = tlb_vaddr_to_host(env,s->pc,MMU_INST_FETCH,mmu_idx);
          if(hva == NULL)
	    ptt->ti[ptt->insn_num].hva = s->pc;
          else
	    ptt->ti[ptt->insn_num].hva = hva;
        }else{
	  ptt->ti[ptt->insn_num].hva = s->pc;
        }
    	ptt->insn_num++;	
