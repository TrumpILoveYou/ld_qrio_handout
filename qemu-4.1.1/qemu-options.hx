...
DEF("qrtag", 0, QEMU_OPTION_qrtag,
    "-qrtag  ppi qrtag options to ignore trace before using qrtag\n", QEMU_ARCH_ALL)
DEF("channel", HAS_ARG, QEMU_OPTION_channel,
    "-channel [num]     ppi channel options to support multi qrio\n", QEMU_ARCH_ALL)
STEXI
@item -h
@findex -h
...
DEF("clockRate", HAS_ARG, QEMU_OPTION_clockRate,
    "-clockRate     Set the Clock Rate\n", QEMU_ARCH_ALL)
	
DEF("tagRate", HAS_ARG, QEMU_OPTION_tagRate,
    "-tagRate     Set the Clock tag Rate\n", QEMU_ARCH_ALL)

DEF("sendRate", HAS_ARG, QEMU_OPTION_sendRate,
    "-sendRate     Set the Clock  send Rate\n", QEMU_ARCH_ALL)
